  ...
  return (
    <View style={{padding:20,flex:1,backgroundColor:'white'}}>
        <View style={{flexDirection: "row",alignItems: "center",gap:5}}>
          ...
          <Text style={{fontSize:20,fontWeight:'bold'}}>Interests Received</Text>
        </View>
        <ScrollView>
...
const styles = StyleSheet.create({
  ...
  profileImage: { width: 100, height: 120, marginTop: 20, borderRadius: 10, marginRight: 15, backgroundColor: "#ccc" },
